...
(function () {
  const DATA_URL = "/assets/data/learn-questions.json?v=20260915-semiconductor-3";
  ...
  function renderElectronicsExplorer(root, question) {
    ...
    load("/assets/js/learn-electronics-explorer-v1.js?v=10").then(() => window.renderShieldioElectronicsExplorer(root, question)).catch(() => { root.textContent="Lekci se nepodařilo načíst. Obnov stránku a zkontroluj připojení."; });
  }
