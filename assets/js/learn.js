...
(function () {
  const DATA_URL = "/assets/data/learn-questions.json?v=20260915-visual-7";
  ...
  function renderElectronicsExplorer(root, question) {
    ...
    const interactionCss = document.createElement("link"); interactionCss.rel="stylesheet"; interactionCss.href="/assets/css/learn-interactions-v1.css?v=1"; document.head.appendChild(interactionCss);
    load("/assets/js/learn-electronics-explorer-v1.js?v=5").then(() => window.renderShieldioElectronicsExplorer(root, question)).catch(() => { root.textContent="Lekci se nepodařilo načíst. Obnov stránku a zkontroluj připojení."; });
  }
