...
for (const term of ['Booleova algebra', 'metastabilitu', 'Flash/ROM', 'Přerušení', 'T klopný obvod', 'posuvný registr', 'Fuzzy řízení', 'výstupní člen', 'pracovní prostor', 'Vstupní periferie', 'Výstupní zařízení']) assert.ok(source.includes(term), `chybí ${term}`);
