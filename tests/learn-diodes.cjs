...
for (const term of [
  ...
  'katodová čára', 'Voltampérová charakteristika', 'U_RRM', 'I_F(AV)', 'I_FSM',
  'germaniová', 'Schottkyho', 'Zener', 'fotodioda', 'PIN', 'varikap', 'tunelová',
  'Měření diody multimetrem', 'Pracovní bod diody'
...
console.log('Polovodiče a diody OK: 12 tematických kapitol, samostatné vizualizace a živá VA simulace');
