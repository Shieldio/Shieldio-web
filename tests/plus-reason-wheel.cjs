...
console.log('Kolo: 40 věcných + 12 humorných návrhů, filtry, humor nikdy nevložen, ruční vložení, bez opakování, audio/mute, zavření a odpojení OK; bez sítě.');
