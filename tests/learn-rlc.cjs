...
for (const required of ['EIA‑96','E192','\\rho\\frac{l}{S}','sériový ztrátový odpor','indukčnost vývodů','potenciometr','odporová dráha','Al₂O₃','elektrolytem','X_L','X_C','rezonance','A_L','M = k','Transformátor','tečková konvence','zaplnění okna','derating']) assert.ok(text.includes(required), `chybí ${required}`);
